...
jugadorRoutes = require('./api/components/jugador/jugador.route');
propiedadRoutes = require('./api/components/propiedad/propiedad.route');
...
app.use('/api', jugadorRoutes);//se define el versionamiento del api
